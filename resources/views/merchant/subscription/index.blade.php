...
@section('page-title', __('messages.subscription'))
    ...
    <div class="bg-yellow-50 dark:bg-yellow-900/30 border-l-4 border-yellow-400 rounded-lg p-6 shadow-sm">
        <div class="flex items-start">
            ...
            <div class="ml-4 flex-1">
                <h3 class="text-lg font-semibold text-yellow-800 dark:text-yellow-200">{{ __('messages.no_merchant_profile') }}</h3>
                <p class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                    {{ __('messages.merchant_profile_required') }}
                </p>
                <div class="mt-4">
                    <a href="{{ route('merchant.dashboard') }}" class="inline-flex items-center px-4 py-2 bg-yellow-600 hover:bg-yellow-700 text-white font-medium rounded-lg transition-colors duration-200">
    ...
    <div class="mb-8">
        ...
        <div class="subscription-card bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-amber-100 text-sm">{{ $currentSubscription->subscriptionType->period_label }} {{ __('messages.billing') }}</p>
                        </div>
                    </div>
                    <div class="text-right">
                        <div class="text-3xl font-bold text-white">{{ $currentSubscription->subscriptionType->formatted_charge }}</div>
                        <div class="text-amber-100 text-sm">{{ __('messages.per') }} {{ $currentSubscription->subscriptionType->period }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-start space-x-3 flex-col">
                            <div class="items-center flex flex-row pl-3 gap-2">
                                 <i class="fas fa-hourglass-half text-amber-600 dark:text-amber-400 text-l"></i>
                ...
                <div class="mt-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                    <div class="flex items-start">
                        <i class="fas fa-info-circle text-amber-600 dark:text-amber-400 mt-0.5 mr-3"></i>
                        <p class="text-sm text-amber-800 dark:text-amber-300">{{ $currentSubscription->subscriptionType->alert_message }}</p>
                    </div>
                </div>
                @endif
            </div>
        ...
        <div class="bg-gray-50 dark:bg-gray-900/50 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-700 p-8 text-center">
            <div class="flex flex-col items-center">
                ...
                <button class="inline-flex items-center px-6 py-3 bg-amber-600 hover:bg-amber-700 text-white font-medium rounded-lg transition-colors duration-200">
