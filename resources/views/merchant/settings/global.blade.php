    ...
    <div class="max-w-6xl mx-auto space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="{{ __('merchant.business_address') }}">
                            @error('address')
                                <div class="text-red-600 text-sm">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div id="delivery-fees-section" style="display: {{ old('delivery_capability', $merchant->delivery_capability ?? false) ? 'block' : 'none' }};">
                        <div class="space-y-4 p-6 bg-slate-50 rounded-lg border border-slate-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                <!-- Dubai -->
                                <div class="space-y-2">
                                    <label class="text-slate-700 font-medium">{{ __('merchant.dubai') }}</label>
                                    <div class="relative">
                                        <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500 text-sm">{{ __('merchant.aed') }}</span>
                                        <input type="number"
                                ...
                                <!-- Abu Dhabi -->
                                <div class="space-y-2">
                                    <label class="text-slate-700 font-medium">{{ __('merchant.abu_dhabi') }}</label>
                                    <div class="relative">
                                        <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500 text-sm">{{ __('merchant.aed') }}</span>
                                        <input type="number"
                                               class="w-full pl-12 pr-4 py-3 border border-slate-300 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all"
                                ...
                                <!-- Sharjah -->
                                <div class="space-y-2">
                                    <label class="text-slate-700 font-medium">{{ __('merchant.sharjah') }}</label>
                                    <div class="relative">
                                        <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500 text-sm">{{ __('merchant.aed') }}</span>
                                        <input type="number"
                                               class="w-full pl-12 pr-4 py-3 border border-slate-300 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all"
                                ...
                                <!-- Ajman -->
                                <div class="space-y-2">
                                    <label class="text-slate-700 font-medium">{{ __('merchant.ajman') }}</label>
                                    <div class="relative">
                                        <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500 text-sm">{{ __('merchant.aed') }}</span>
                                        <input type="number"
                                               class="w-full pl-12 pr-4 py-3 border border-slate-300 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all"
                                ...
                                <!-- Ras Al Khaimah -->
                                <div class="space-y-2">
                                    <label class="text-slate-700 font-medium">{{ __('merchant.ras_al_khaimah') }}</label>
                                    <div class="relative">
                                        <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500 text-sm">{{ __('merchant.aed') }}</span>
                                        <input type="number"
                                               class="w-full pl-12 pr-4 py-3 border border-slate-300 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all"
                                ...
                                <!-- Fujairah -->
                                <div class="space-y-2">
                                    <label class="text-slate-700 font-medium">{{ __('merchant.fujairah') }}</label>
                                    <div class="relative">
                                        <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500 text-sm">{{ __('merchant.aed') }}</span>
                                        <input type="number"
                                               class="w-full pl-12 pr-4 py-3 border border-slate-300 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all"
                                ...
                                <!-- Umm Al Quwain -->
                                <div class="space-y-2">
                                    <label class="text-slate-700 font-medium">{{ __('merchant.umm_al_quwain') }}</label>
                                    <div class="relative">
                                        <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500 text-sm">{{ __('merchant.aed') }}</span>
                                        <input type="number"
                                               class="w-full pl-12 pr-4 py-3 border border-slate-300 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-indigo-50 to-blue-50 border-b border-gray-100 px-6 py-4">
                <h2 class="text-lg font-semibold text-gray-900 flex items-center gap-2 rtl:flex-row-reverse">
                    <div class="w-8 h-8 bg-indigo-100 rounded-lg flex items-center justify-center">
                        <i class="fas fa-chart-line text-indigo-600 text-sm"></i>
                    </div>
                    {{ __('merchant.business_status') }}
                </h2>
                <p class="text-gray-600 text-sm mt-1 rtl:text-right">{{ __('merchant.business_status_subtitle') }}</p>
            </div>
            <div class="p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-4">
                        <div class="flex justify-between items-center py-3 border-b border-slate-200">
                            <span class="text-slate-600 rtl:order-2">{{ __('merchant.business_status') }}:</span>
                            @if($merchant->is_verified)
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-emerald-500/10 text-emerald-600 border border-emerald-500/20 rtl:flex-row-reverse rtl:order-1">
                                    <i class="fas fa-check-circle w-3 h-3 mr-1 rtl:mr-0 rtl:ml-1"></i>
                                    {{ __('merchant.verified') }}
                                </span>
                            @else
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-500/10 text-amber-600 border border-amber-500/20 rtl:flex-row-reverse rtl:order-1">
                                    <i class="fas fa-clock w-3 h-3 mr-1 rtl:mr-0 rtl:ml-1"></i>
                                    {{ __('merchant.pending_verification') }}
                                </span>
                            @endif
                        </div>
                        <div class="flex justify-between items-center py-3 border-b border-slate-200">
                            <span class="text-slate-600 rtl:order-2">{{ __('merchant.registration_date') }}:</span>
                            <span class="font-medium text-slate-800 rtl:order-1">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center py-3 border-b border-slate-200">
                            <span class="text-slate-600 rtl:order-2">{{ __('merchant.delivery_service') }}:</span>
                            ...
                            @else
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-slate-500/10 text-slate-600 border border-slate-500/20 rtl:flex-row-reverse rtl:order-1">
                                    <i class="fas fa-times w-3 h-3 mr-1 rtl:mr-0 rtl:ml-1"></i>
                                    {{ __('merchant.disabled') }}
                                </span>
                            @endif
                        </div>
                        <div class="flex justify-between items-center py-3">
                            <span class="text-slate-600 rtl:order-2">{{ __('merchant.last_updated') }}:</span>
                            <span class="font-medium text-slate-800 rtl:order-1">
