...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 personal-settings-container">
    <div class="mb-8">
        <h2 class="text-2xl sm:text-3xl font-semibold text-gray-900">{{ __('merchant.personal_settings') }}</h2>
        <p class="mt-2 text-sm text-gray-500">{{ __('merchant.personal_information_subtitle') }}</p>
    </div>
    <!-- Success Message -->
    @if(session('success'))
    ...
    <div class="grid grid-cols-1 gap-8">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <form action="{{ route('merchant.settings.personal.update') }}" method="POST" class="p-6 form-grid">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            <label for="name" class="block text-sm font-medium text-gray-700 mb-2 form-label">
                        ...
                        <!-- Email Address -->
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-2 form-label">
                        ...
                        <!-- Phone Number -->
                        <div>
                            <label for="phone" class="block text-sm font-medium text-gray-700 mb-2 form-label">
                    ...
                    <div class="mt-8 flex justify-end">
                        <button type="submit"
                                class="bg-gray-900 hover:bg-gray-800 text-white px-6 py-3 rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2">
                ...
                <form action="{{ route('merchant.settings.personal.update') }}" method="POST" class="p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- New Password -->
                            <div>
                                <label for="password" class="block text-sm font-medium text-gray-700 mb-2 form-label">
                        ...
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 password-requirements">
                            <h4 class="text-sm font-medium text-gray-900 mb-2">{{ __('merchant.password_requirements') }}:</h4>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    <!-- Account Type -->
                    <div class="flex items-center justify-between py-3 border-b border-gray-100 account-info-item">
                        <div>
                    ...
                    <!-- Phone Status -->
                    <div class="flex items-center justify-between py-3 account-info-item">
                        <div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-3">
                    <a href="{{ route('merchant.settings.global') }}" class="flex items-center p-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-50 transition-colors quick-actions-item">
                    ...
                    <a href="#" class="flex items-center p-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-50 transition-colors quick-actions-item">
                        <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
