                        ...
                        <div class="form-group">
                            ...
                            <div data-lang-field="product_description" data-lang="en" style="display: block;">
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          name="description"
                                          rows="5"
                                          placeholder="{{ __('provider.enter_product_description_english') }}">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div data-lang-field="product_description" data-lang="ar" style="display: none;" dir="rtl">
                                <textarea class="form-control @error('product_description_arabic') is-invalid @enderror"
                                          ...
                                          rows="5"
                                          placeholder="{{ __('provider.enter_product_description_arabic') }}">{{ old('product_description_arabic') }}</textarea>
