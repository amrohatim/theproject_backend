                        ...
                        <div class="mb-4" style="border-radius: 8px; padding: 16px; border: 1px solid #e0e1e5;">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" min="1" class="form-control" id="min_order" name="min_order" value="{{ old('min_order', 1) }}" required 
                                        style="background-color: var(--discord-dark); border: none; color: var(--discord-lightest); padding: 10px 12px; border-radius: 4px; width: 100%;">
                                        ...
                                        <optgroup label="{{ $parentCategory->name }}" style="background-color: var(--discord-dark); color: var(--discord-primary);">
                                            ...
                                            @foreach($parentCategory->children as $childCategory)
                                                <option value="{{ $childCategory->id }}" {{ old('category_id') == $childCategory->id ? 'selected' : '' }}
                                                    style="background-color: var(--discord-dark); padding-left: 20px;" data-is-parent="false">
                                                    — {{ $childCategory->name }}
                                                </option>
                                            @endforeach
                                        </optgroup>
