...
<head>
    ...
    <title>Email Verification - Provider Registration</title>
...
<body class="bg-gradient-to-br from-pink-50 via-purple-50 to-rose-50 min-h-screen">
        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="form-container rounded-2xl shadow-xl p-8">
                ...
                <div class="text-center mb-8">
                    <div class="email-icon inline-block p-4 bg-pink-100 rounded-full mb-4">
                    ...
                    <p class="text-lg font-semibold text-pink-600 mb-4">{{ $user->email }}</p>
                ...
                <form method="POST" action="{{ route('provider.email.verify.submit') }}" class="space-y-6">
                    @csrf
                    ...
                    <div class="text-center">
                        ...
                        <input
                            ...
                            maxlength="6"
                            placeholder="000000"
                            class="verification-code w-full text-center px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all duration-300"
                        >
                    </div>
    ...
    <script>
        function resendEmail() {
            fetch('{{ route("provider.email.resend") }}', {
                method: 'POST',
                headers: {
