...
<head>
    ...
    <title>Glowlabs - {{ __('messages.provider_registration') }}</title>
...
<body class="min-h-screen bg-gray-50 {{ $isRtl ? 'rtl' : '' }}">
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 text-white p-12 flex-col items-start justify-top bg-[url('/assets/providerBanner.webp')] bg-cover">
