        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="form-container rounded-2xl shadow-xl p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-lg font-semibold text-purple-600 mb-4">{{ $user->phone }}</p>
                ...
                <!-- OTP Form -->
                <form method="POST" action="{{ route('vendor.otp.verify.submit') }}" class="space-y-6">
                    @csrf
