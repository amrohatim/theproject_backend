...
<head>
    ...
    <title>Glowlabs - {{ __('messages.merchant_registration') }}</title>
    ...
    <script>
        ...
        window.appTranslations = {
            ...
            'clear_location': '{{ __('messages.clear_location') }}',
            'loading_map': '{{ __('messages.loading_map') }}',
            'loading_google_maps': '{{ __('messages.loading_google_maps') }}',
            'selected_address_will_appear_here': '{{ __('messages.selected_address_will_appear_here') }}',
            ...
            'click_to_change': '{{ __('messages.click_to_change') }}',
            'cancel': '{{ __('messages.cancel') }}',
            'retry': '{{ __('messages.retry') }}',
            'business_name_is_required': '{{ __('messages.business_name_is_required') }}',
            'business_name_cannot_exceed_255_characters': '{{ __('messages.business_name_cannot_exceed_255_characters') }}',
            'email_is_required': '{{ __('messages.email_is_required') }}',
            'please_enter_a_valid_email_address': '{{ __('messages.please_enter_a_valid_email_address') }}',
            'phone_number_is_required': '{{ __('messages.phone_number_is_required') }}',
            'please_enter_a_valid_9_digit_uae_phone_number': '{{ __('messages.please_enter_a_valid_9_digit_uae_phone_number') }}',
            'emirate_is_required': '{{ __('messages.emirate_is_required') }}',
            'password_is_required': '{{ __('messages.password_is_required') }}',
            'password_must_be_at_least_8_characters': '{{ __('messages.password_must_be_at_least_8_characters') }}',
            'password_confirmation_is_required': '{{ __('messages.password_confirmation_is_required') }}',
            'password_confirmation_does_not_match': '{{ __('messages.password_confirmation_does_not_match') }}',
            'uae_id_front_side_is_required': '{{ __('messages.uae_id_front_side_is_required') }}',
            'uae_id_back_side_is_required': '{{ __('messages.uae_id_back_side_is_required') }}',
