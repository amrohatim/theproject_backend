...
<div class="container mx-auto px-4 py-6">
        ...
        <div class="info-card px-6 py-4">
            <div class="flex items-center text-white">
                ...
                <div class="flex items-center justify-center">
                    ...
                    <p class="text-blue-800  font-medium text-lg">The merchant license has been rejected and an email notification has been sent to the user.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="p-6">
                <div class="space-y-4">
                    <div class="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-700">
                        ...
                        <span class="text-sm font-semibold text-gray-900 dark:text-white">{{ $merchant->business_name }}</span>
                    </div>
                    <div class="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-700">
                        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">License Status</span>
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $merchant->license_status === 'active' ? 'bg-green-100 text-green-800' : ($merchant->license_status === 'rejected' ? 'bg-red-100 text-red-800' : 'bg-yellow-100 text-yellow-800') }}">
                            <i class="fas fa-circle text-xs mr-1"></i>
                            {{ ucfirst($merchant->license_status) }}
                        </span>
                    </div>
                    <div class="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-700">
                        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">License Submitted</span>
                        <span class="text-sm font-semibold text-gray-900 dark:text-white">{{ $merchant->created_at->format('M d, Y') }}</span>
                    </div>
                    <div class="flex items-center justify-between py-3 {{ $merchant->license_rejection_reason ? 'border-b border-gray-100 dark:border-gray-700' : '' }}">
                        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">License Rejected</span>
                        <span class="text-sm font-semibold text-gray-900 dark:text-white">{{ $merchant->updated_at->format('M d, Y H:i') }}</span>
                    </div>
                    ...
                    <div class="py-3">
                        ...
                        <div class="bg-red-50 border border-red-200 rounded-lg p-3">
                            <p class="text-sm text-red-800">{{ $merchant->license_rejection_reason }}</p>
                        </div>
                    </div>
                    @endif
                </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
        ...
        <div class="p-6">
            ...
            <form action="{{ route('admin.merchant-licenses.handle-post-rejection-choice') }}" method="POST" id="userActionForm">
                @csrf
    ...
    <div class="flex justify-center">
        <a href="{{ route('admin.merchant-licenses.index') }}"
           class="inline-flex items-center px-6 py-3 bg-white hover:bg-gray-200 text-gray-700 font-medium rounded-lg transition-colors duration-200 focus:outline-none focus:ring-4 focus:ring-gray-300">
            <i class="fas fa-arrow-left mr-2"></i>
            Back to Merchant Licenses
        </a>
    </div>
</div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-4">
                            ...
                            <ul class="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                                ...
                                <li class="flex items-center">
                                    <i class="fas fa-circle text-xs text-red-500 mr-2"></i>
                                    All related merchant/business data
                                </li>
                                <li class="flex items-center">
                                    <i class="fas fa-circle text-xs text-red-500 mr-2"></i>
                                    Products and services created by this merchant
                                </li>
                            </ul>
                        </div>
