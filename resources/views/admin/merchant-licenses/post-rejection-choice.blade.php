            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        <p>The merchant license has been rejected and an email notification has been sent to the user.</p>
                    </div>
                                ...
                                <div class="card-body">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-danger">{{ ucfirst($merchant->license_status) }}</span></td>
                                        </tr>
                                        <tr>
                                            <td><strong>License Submitted:</strong></td>
                                            <td>{{ $merchant->created_at->format('M d, Y') }}</td>
                                        </tr>
                                        <tr>
                                            <td><strong>License Rejected:</strong></td>
                                            <td>{{ $merchant->updated_at->format('M d, Y H:i') }}</td>
                                        </tr>
                                        @if($merchant->license_rejection_reason)
                                        <tr>
                                            <td><strong>Rejection Reason:</strong></td>
                                            <td class="text-danger">{{ $merchant->license_rejection_reason }}</td>
                                        </tr>
                                        @endif
                                    </table>
                                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <a href="{{ route('admin.merchant-licenses.index') }}" class="btn btn-secondary">
                                <i class="fas fa-arrow-left"></i> Back to Merchant Licenses
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul>
                    ...
                    <li>All related merchant/business data</li>
                    <li>Products and services created by this merchant</li>
                </ul>
