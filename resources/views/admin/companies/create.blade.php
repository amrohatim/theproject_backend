...
<div class="container mx-auto">
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Create New Company</h2>
        <p class="mt-1 text-gray-600 dark:text-gray-400">Add a new vendor company to the system</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="can_deliver" name="can_deliver" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                        <option value="1" {{ old('can_deliver', '1') == '1' ? 'selected' : '' }}>Can handle own deliveries</option>
                        <option value="0" {{ old('can_deliver') == '0' ? 'selected' : '' }}>Cannot handle deliveries</option>
                    </select>
