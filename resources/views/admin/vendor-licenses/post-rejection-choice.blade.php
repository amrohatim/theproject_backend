            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        <p>The vendor license has been rejected and an email notification has been sent to the user.</p>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <a href="{{ route('admin.vendor-licenses.index') }}" class="btn btn-secondary">
                                <i class="fas fa-arrow-left"></i> Back to Vendor Licenses
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul>
                    ...
                    <li>All related vendor/company data</li>
                </ul>
