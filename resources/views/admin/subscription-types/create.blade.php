...
<div class="container mx-auto">
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Create Subscription Plan</h2>
                <p class="mt-1 text-gray-600 dark:text-gray-400">Add a new subscription plan for users</p>
            </div>
            <div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700">
        <form action="{{ route('admin.subscription-types.store') }}" method="POST" class="p-6" id="subscriptionForm">
            @csrf
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <select name="type" 
                            ...
                            <option value="merchant" {{ old('type') == 'merchant' ? 'selected' : '' }}>Merchant</option>
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input type="number" 
                               ...
                               min="0"
                               max="999999.99"
                               class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-12 pr-12 shadow-sm sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md @error('charge') border-red-500 @enderror" 
                               placeholder="0.00"
                               required>
                    </div>
                    @error('charge')
            ...
            <div class="mt-8 flex items-center justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <button type="submit" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:border-indigo-900 focus:ring ring-indigo-300 disabled:opacity-25 transition ease-in-out duration-150">
                    <i class="fas fa-save mr-2"></i> Create Subscription Plan
                </button>
            </div>
        </form>
    </div>
