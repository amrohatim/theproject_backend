    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
        <form method="POST" action="{{ route('vendor.settings.products-managers.update', $productsManager) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Status -->
                <div class="form-input-container has-label">
                    <label for="status" class="form-label">{{ __('vendor.account_status') }} <span class="text-red-500">*</span></label>
                ...
                <!-- Password -->
                <div class="form-input-container has-label">
                    <label for="password" class="form-label">{{ __('vendor.new_password') }}</label>
                ...
                <!-- Confirm Password -->
                <div class="form-input-container has-label">
                    <label for="password_confirmation" class="form-label">{{ __('vendor.confirm_password') }}</label>
