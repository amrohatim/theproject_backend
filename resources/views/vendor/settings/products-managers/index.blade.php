...
@section('title', __('vendor.products_managers_management'))
@section('page-title', __('vendor.products_managers_management'))

@section('content')
<div class="container mx-auto">
    <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-800 dark:text-white">{{ __('vendor.products_managers') }}</h2>
            <p class="mt-1 text-gray-600 dark:text-gray-400">{{ __('vendor.manage_products_managers_description') }}</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-medium text-gray-900 dark:text-white">{{ __('vendor.products_managers_list') }}</h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ trans_choice('vendor.total_products_managers', $productsManagers->total(), ['count' => $productsManagers->total()]) }}
            </p>
        </div>
                        ...
                        @foreach($productsManagers as $productsManager)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-sm text-gray-500 dark:text-gray-400">
                                        {{ __('vendor.full_access_all_branches') }}
                                    </div>
                                </td>
        ...
        <div class="mt-3 text-center">
            ...
            <div class="mt-2 px-7 py-3">
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ __('vendor.delete_products_manager_confirmation_prefix') }} <span id="deleteProductsManagerName" class="font-medium"></span>{{ __('vendor.delete_products_manager_confirmation_suffix') }}
                </p>
            </div>
