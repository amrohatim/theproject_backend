        ...
        <form action="{{ route('vendor.deals.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="mt-4">
                    ...
                    <div class="space-y-2">
                        <label class="inline-flex items-center">
                            <input type="radio" name="applies_to" value="all" class="form-radio" {{ old('applies_to', 'all') == 'all' ? 'checked' : '' }} onchange="toggleSelectionContainers()">
                            <span class="ml-2">All Products</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" name="applies_to" value="products" class="form-radio" {{ old('applies_to') == 'products' ? 'checked' : '' }} onchange="toggleSelectionContainers()">
                            <span class="ml-2">Selected Products</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" name="applies_to" value="categories" class="form-radio" {{ old('applies_to') == 'categories' ? 'checked' : '' }} onchange="toggleSelectionContainers()">
                ...
                <div id="categories-container" class="mt-4" style="display: none;">
                    ...
                    <div class="selection-container">
                        @foreach($categories as $category)
                            <div class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded">
                                <label class="inline-flex items-center w-full">
                                    <input type="checkbox" name="category_ids[]" value="{{ $category->id }}" class="form-checkbox" {{ in_array($category->id, old('category_ids', [])) ? 'checked' : '' }}>
