...
<style>
    ...
    @media (max-width: 768px) {
        .vendor-deals-form .lang-toggle button {
...
@section('content')
<div class="container mx-auto vendor-deals-form">
            ...
            <div class="form-section">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <!-- English Title -->
                        <div data-lang-field="title" data-lang="en" class="form-input-container has-label mb-3 active-language-field">
                        ...
                        <!-- Arabic Title -->
                        <div data-lang-field="title" data-lang="ar" class="form-input-container has-label mb-3" style="display: none;">
                ...
                <div class="mt-4">
                    ...
                    <!-- English Description -->
                    <div data-lang-field="description" data-lang="en" class="form-input-container has-label mb-3 active-language-field">
                    ...
                    <!-- Arabic Description -->
                    <div data-lang-field="description" data-lang="ar" class="form-input-container has-label mb-3" style="display: none;">
                        <textarea name="description_arabic" id="description_arabic" rows="3" class="form-textarea text-right"  dir="rtl">{{ old('description_arabic') }}</textarea>
                ...
                <div class="mt-4">
                    ...
                    <div data-lang-field="promotional_message" data-lang="en" class="form-input-container has-label mb-3 active-language-field">
                        <div class="relative">
                    ...
                    <div data-lang-field="promotional_message" data-lang="ar" class="form-input-container has-label mb-3" style="display: none;">
                        <div class="relative">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div class="form-input-container has-label">
                        ...
                        <input type="text" name="start_date" id="start_date" value="{{ old('start_date', date('Y-m-d')) }}" class="form-input datepicker {{ app()->getLocale() == 'ar' ? 'text-right' : 'text-left' }}" placeholder="{{ __('messages.select_start_date') }}" min="{{ date('Y-m-d') }}" required>
                        @error('start_date')
                            <span class="field-error-message {{ app()->getLocale() == 'ar' ? 'text-right' : 'text-left' }}">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-input-container has-label">
                        ...
                        <input type="text" name="end_date" id="end_date" value="{{ old('end_date', date('Y-m-d', strtotime('+30 days'))) }}" class="form-input datepicker {{ app()->getLocale() == 'ar' ? 'text-right' : 'text-left' }}" placeholder="{{ __('messages.select_end_date') }}" min="{{ date('Y-m-d') }}" required>
                        @error('end_date')
                            <span class="field-error-message {{ app()->getLocale() == 'ar' ? 'text-right' : 'text-left' }}">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <!-- Image -->
                <div class="form-input-container has-label mt-4">
                    <label for="image" class="form-label {{ app()->getLocale() == 'ar' ? 'text-right' : 'text-left' }}">{{ __('messages.deal_image') }} <span class="text-red-500">*</span></label>
                    <input type="file" name="image" id="image" class="form-input" accept="image/jpeg,image/png,image/jpg,image/gif,image/svg+xml" required onchange="previewImage(event)">
