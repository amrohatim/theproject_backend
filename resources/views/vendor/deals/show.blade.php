    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div class="detail-section">
                ...
                @if($deal->applies_to == 'categories' && !empty($deal->category_ids))
                    <div class="mt-4">
                        <h4 class="font-medium text-gray-700 dark:text-gray-300 mb-2">Selected Categories</h4>
                        <div class="selection-list">
                            @php
                                $categoryIds = is_string($deal->category_ids) ? json_decode($deal->category_ids, true) : $deal->category_ids;
                            ...
                            @forelse($selectedCategories as $category)
                                <div class="selection-item">
                                    ...
                                    <div class="text-sm text-gray-500">{{ ucfirst($category->type) }}</div>
                                </div>
                            @empty
                                <div class="p-4 text-center text-gray-500">No categories selected</div>
                            @endforelse
                        </div>
                    </div>
                @endif
