                    ...
                    @forelse($jobs as $job)
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900 dark:text-white jobs-title">{{ $job->title }}</div>
                                <div class="text-xs text-gray-500 dark:text-gray-400 jobs-description">{{ \Illuminate\Support\Str::limit($job->description, 80) }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
