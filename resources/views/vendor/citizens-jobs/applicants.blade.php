            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Passport</th>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4">
                                @if($application->password_image)
                                    <a href="{{ route('vendor.citizens-jobs.applicants.passport', $application->id) }}" target="_blank" rel="noopener">
                                        <img src="{{ route('vendor.citizens-jobs.applicants.passport', $application->id) }}" alt="Passport image" class="h-14 w-14 object-cover rounded-md border border-gray-200 dark:border-gray-600">
                                    </a>
                                @else
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end space-x-3">
                                    ...
                                    @endif
                                    <form method="POST" action="{{ route('vendor.citizens-jobs.applicants.destroy', $application->id) }}" onsubmit="return confirm('Delete this application?');">
                                        @csrf
                                        @method('DELETE')
