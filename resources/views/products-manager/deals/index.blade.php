...
<div class="container mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700">
        <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
            ...
            <a href="{{ route('products-manager.deals.create') }}" class="inline-flex items-center px-3 py-2 bg-[var(--primary)] text-white rounded-md hover:opacity-90 active:opacity-80 text-sm">
        ...
        <div class="p-6">
                    ...
                    @foreach ($deals as $deal)
                        <div class="bg-white dark:bg-gray-700 rounded-lg shadow overflow-hidden hover:shadow-lg transition-shadow duration-200">
                            ...
                            <div class="h-40 bg-gray-200 dark:bg-gray-600 relative" style="background-image: url('{{ $deal->image }}'); background-size: cover; background-position: center;">
                                <!-- Discount badge -->
                                <div class="absolute top-2 right-2 bg-[var(--primary)] text-white px-2 py-1 rounded-full text-sm font-bold">
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex justify-end gap-2">
                                    <a href="{{ route('products-manager.deals.edit', $deal) }}" class="inline-flex items-center px-3 py-1 bg-[var(--primary)] text-white rounded text-sm hover:opacity-90">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <a href="{{ route('products-manager.deals.create') }}" class="inline-flex items-center px-4 py-2 bg-[var(--primary)] text-white rounded-md hover:opacity-90">
                        <i class="fas fa-plus mr-2"></i>{{ __('products_manager.create_deal') }}
                    </a>
                </div>
            @endif
