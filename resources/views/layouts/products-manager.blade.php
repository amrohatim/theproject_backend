                        ...
                        <div class="flex items-center space-x-4">
                            <div class="relative group">
                                ...
                                >
                                    ...
                                    @if(($productsManagerUnreadCount ?? 0) > 0)
                                        <span class="absolute -top-1 -right-1 inline-flex min-w-[1.05rem] h-[1.05rem] items-center justify-center rounded-full bg-red-500 px-1 text-[10px] font-semibold leading-none text-white">
                                            {{ $productsManagerUnreadCount > 99 ? '99+' : $productsManagerUnreadCount }}
                                        </span>
                                    @endif
                                </a>
                                ...
                                <div class="hidden group-hover:block group-focus-within:block absolute top-10 z-50 w-80 max-w-[calc(100vw-1rem)] {{ app()->getLocale() === 'ar' ? 'left-0' : 'right-0' }} rounded-lg border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800">
                                    ...
                                    <div class="max-h-80 overflow-y-auto">
                                        @forelse(($productsManagerNotificationPreview ?? collect()) as $notification)
