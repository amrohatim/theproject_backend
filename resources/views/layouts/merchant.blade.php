...
<head>
    ...
    <title>@yield('title', 'Merchant Dashboard') | glowlabs</title>
                ...
                <div class="header-content">
                    ...
                    <div class="header-right">
                        <div class="relative group">
                            ...
                            <div class="hidden group-hover:block group-focus-within:block absolute top-10 z-50 w-80 max-w-[calc(100vw-1rem)] {{ app()->getLocale() === 'ar' ? 'left-0' : 'right-0' }} rounded-lg border border-gray-200 bg-white shadow-lg">
