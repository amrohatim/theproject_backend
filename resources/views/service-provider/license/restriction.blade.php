...
<head>
    ...
    <style>
        ...
        .service-theme { background: linear-gradient(135deg, #3b82f6, #1d4ed8); }
    </style>
</head>
        ...
        <div class="max-w-2xl w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600">
                    {{ __('service_provider.store_status_check') }}
                </p>
            </div>
            ...
            <div class="status-container rounded-2xl shadow-xl p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 mb-2">
                        {{ __('service_provider.store_status_not_active') }}
                    </h2>

                    <p class="text-gray-600 mb-4">
                        {{ session('license_message', __('service_provider.store_inactive_desc')) }}
                    </p>
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                            <div class="flex items-center">
                                ...
                                <span class="text-blue-800 font-medium">
                                    {{ __('service_provider.vendor_license_status') }}: 
                    ...
                    <a href="{{ route('service-provider.dashboard') }}"
                       class="inline-flex items-center px-6 py-3 service-theme text-white font-semibold rounded-lg hover:from-blue-600 hover:to-blue-800 transition-all duration-300 transform hover:scale-105">
                        <i class="fas fa-arrow-left mr-2"></i>
                        {{ __('service_provider.back_to_dashboard') }}
                    </a>
                </div>
                ...
                <div class="bg-blue-50 rounded-lg p-6 mb-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">
                        ...
                        {{ __('service_provider.access_restriction_info') }}
                    </h3>
                    <div class="space-y-3 text-gray-700">
                        <p class="flex items-start">
                            <i class="fas fa-circle text-blue-400 text-xs mt-2 mr-3"></i>
                            {{ __('service_provider.service_creation_restricted') }}
                        </p>
                        <p class="flex items-start">
                            <i class="fas fa-circle text-blue-400 text-xs mt-2 mr-3"></i>
                            {{ __('service_provider.vendor_license_required') }}
                        </p>
                        <p class="flex items-start">
                            <i class="fas fa-circle text-blue-400 text-xs mt-2 mr-3"></i>
                            {{ __('service_provider.contact_vendor_admin') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-green-50 rounded-lg p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">{{ __('service_provider.need_help') }}?</h3>
                    <p class="text-gray-600 mb-4">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <a href="tel:+971501234567" 
                           class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200">
                            ...
                            {{ __('service_provider.call_support') }}
                        </a>
                    </div>
                </div>
