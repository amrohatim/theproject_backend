...
<div class="container mx-auto service-provider-deals-form">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
        <form action="{{ route('service-provider.deals.update', $deal->id) }}" method="POST" enctype="multipart/form-data" id="dealForm">
            @csrf
            @method('PUT')
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-2 space-y-2">
                        <div class="flex items-center">
                            <input id="status_active" name="status" type="radio" value="active" class="focus:ring-[var(--primary)] h-4 w-4 text-[var(--primary)] border-gray-300 dark:border-gray-600" {{ old('status', $deal->status) == 'active' ? 'checked' : '' }}>
                        ...
                        <div class="flex items-center">
                            <input id="status_inactive" name="status" type="radio" value="inactive" class="focus:ring-[var(--primary)] h-4 w-4 text-[var(--primary)] border-gray-300 dark:border-gray-600" {{ old('status', $deal->status) == 'inactive' ? 'checked' : '' }}>
